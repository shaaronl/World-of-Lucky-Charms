...
public final class VirtualWorld extends PApplet {
    ...
    public static int luckyCharmCount = 0;
    ...
    */
    ...
    public void mousePressed() {
        ...
        //creates rainbow if the house is clicked
        if (pressed.x == 21 && pressed.y == 26) {
                Parse.parseRainbow(world, imageStore); // makes rainbow
        }
        else{
            ActionEntity unicorn = new Unicorn("unicorn", pressed, imageStore.getImageList("unicorn"), 0.5, 0.5);
    ...
    private void scheduleActions(WorldModel world, EventScheduler scheduler, ImageStore imageStore) {
        for (Entity entity : world.getEntities()) {
            if(entity instanceof AnimationEntity){ //TODO: am i supposed to do this
